  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`
            ${styles.techIcons} w-1/2 h-full absolute left-10 top-13 sm:flex items-center hidden
          `}
        >
        ...
        <p
          className="text-lg z-20 tracking-wide font-medium text-white transform-gpu mt-auto pb-4"
